...
const SideMenuColumn = (props: SideMenuColumnProps): JSX.Element => {
    ...
    return (
        <div
            className={(selectedNote?.note_id === note.id ? "bg-base-200" : "bg-white") + " flex justify-between cursor-pointer items-center border-t h-20 p-5 hover:bg-base-300 break-all"}
            style={isDeleted ? {
