...
const AudioDevices = (): JSX.Element => {
    ...
    return (
        <select className="select select-bordered w-full max-w-xs focus:outline-none" name="audio-devices" onChange={change}>
            <option disabled selected >マイクを選択してください</option>
