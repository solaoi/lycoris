...
const TraceStartButton = (): JSX.Element => {
    ...
    return (
        <button className="btn gap-2 bg-white border border-solid border-neutral-300 text-warning" onClick={click} disabled={transcriptionAccuracy === "off" || isRecording || isTracing || !isTracable}>
