...
const RecordStartButton = (): JSX.Element => {
    ...
    return (
        <button className="btn gap-2 bg-white border border-solid border-neutral-300 text-primary" disabled={(deviceLabel === null && !hasDesktopAudio) || speakerLanguage === null || isTracing || (isRecording && recordingNote !== selectedNote?.note_id)} onClick={click}>
