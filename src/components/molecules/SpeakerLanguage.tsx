...
const SpeakerLanguage = (): JSX.Element => {
    ...
    return (
        <div className="dropdown">
            {(isRecording || isTracing || downloadedModels.length === 0) ? <label tabIndex={0} className="group normal-case btn w-52 flex justify-between btn-disabled text-inherit" style={{ backgroundColor: "hsl(var(--b1) / var(--tw-bg-opacity))", border: "1px solid hsl(var(--bc) / 0.2)" }}>
                ...
                <div className="w-24 invisible rounded text-[12px] 
                        ...
                        group-hover:visible absolute ">話し手の言語
                </div>
