...
const SideMenu = (): JSX.Element => {
    ...
    return (
        <div className="relative" style={{ height: `calc(100vh - 64px)` }}>
            <div className="absolute z-[5] mt-2" style={{ right: isOpen ? "-8px" : "-16px" }}>
                <button className="btn btn-circle w-4 bg-white" onClick={() => setOpen(!isOpen)}>
                    {isOpen ? <ChevronLeft /> : <ChevronRight />}
                </button>
            </div>
            <div className="justify-between border-r bg-base-100 w-[320px]" style={{ display: isOpen ? "flex" : "none", flexFlow: "column" }}>
