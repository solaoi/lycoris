...
use crate::module::model_type_nllb::ModelTypeNllb;
...
pub struct NllbModelDownloader {
    app_handle: AppHandle,
}
impl NllbModelDownloader {
    pub fn new(app_handle: AppHandle) -> Self {
        Self { app_handle }
    }

    #[tokio::main]
    pub async fn download(&self, model_type: ModelTypeNllb) {
        let model_path: &str = &format!("resources/nllb200-{}.zip", model_type.as_str());
        let path: &str = &self
            .app_handle
            .path_resolver()
            ...
            .to_string();
        let url: &str = &format!(
            "https://object-storage.tyo1.conoha.io/v1/nc_b22de95e3cf1434da07499038766e2b7/lycoris/nllb200-{}.zip",
            model_type.as_str()
        );
